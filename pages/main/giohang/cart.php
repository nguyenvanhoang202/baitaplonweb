    ...
    ?>
        <tr>
            ...
            <td style="border: 2px solid black;">
                <a class="text-success" href="pages/main/giohang/suasoluong.php?tru=<?php echo $cart_item['id'] ?>"><button style="background-color: black; color: aliceblue;">−</button></a>
                <?php echo $cart_item['soluong'] ?>
                <a class="text-success" href="pages/main/giohang/suasoluong.php?cong=<?php echo $cart_item['id'] ?>"><button style="background-color: black; color: aliceblue;">+</button></a>
            </td>
            ...
            <td style="border: 2px solid black;"><a class="btn-delete" href="pages/main/giohang/xoasanpham.php?xoa=<?php echo $cart_item['id'] ?>">XÓA</a></td>
        </tr>
